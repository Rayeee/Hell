...
import winter.hell.util.HellBeanUtils;
...
public abstract class WebAPIBaseController {
    ...
    ResponseEntity<Map<String, Object>> handleServiceException(HttpServletRequest req,
        ...
        if (e.getErrorCode().equals("") || e.getErrorCode() == null)
            ...
            return new ResponseEntity<Map<String, Object>>(HellBeanUtils.killNull(e.getErrorCode()), e.getErrorMessage(), new HashMap<String, Object>());
    }

    @ExceptionHandler(HellSystemException.class)
    public
    @ResponseBody
    ResponseEntity<Map<String, Object>> handleSystemException(HttpServletRequest req,
                                                              HellSystemException e) {
    ...
    public static class ValidationErrorSimple {
        ...
        public ValidationErrorSimple(ObjectError e) {
            ...
            this.message = MessageFormat.format(HellBeanUtils.killNull(e.getDefaultMessage()), e.getArguments());
            this.code = e.getCode();
    ...
    ResponseEntity<List<ValidationErrorSimple>> handleBindException(HttpServletRequest req,
        ...
        HellSystemException sysEx = new HellSystemException(WebAPIExceptions.ERR_WEBAPI_VALIDATION);
    ...
    ResponseEntity<String> handleThrowable(HttpServletRequest req, Throwable exception) {
        ...
        if (exception.getCause() instanceof HellServiceException) {
            HellServiceException anubisServiceException = (HellServiceException) exception.getCause();
            return new ResponseEntity<String>(anubisServiceException.getErrorCode(), anubisServiceException.getMessage(), null);
        } else {
            HellSystemException se = new HellSystemException(WebAPIExceptions.ERR_UNKNOWN);
